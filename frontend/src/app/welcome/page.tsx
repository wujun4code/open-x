                ...
                <div className="text-center space-y-6">
                    ...
                    <div className="grid grid-cols-3 gap-4 max-w-lg mx-auto mt-8">
                        <div className="p-4 bg-blue-50 rounded-xl">
                            ...
                            <p className="text-sm font-medium text-gray-700">Share Ideas</p>
                        </div>
            ...
            content: (
                <div className="space-y-6">
                    ...
                    <div className="space-y-3">
                        {[
                            { name: 'Tech Enthusiast', username: 'techie', bio: 'Sharing the latest in tech and innovation' },
                            { name: 'Creative Mind', username: 'creative', bio: 'Art, design, and creative inspiration' },
                            { name: 'Thought Leader', username: 'thinker', bio: 'Ideas that shape the future' },
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-600 mt-1">{suggestedUser.bio}</p>
                                        </div>
                                    </div>
        ...
        },
        {
            ...
            content: (
                <div className="text-center space-y-6">
                    ...
                    <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-2xl p-8 max-w-lg mx-auto border border-blue-100">
                        <h3 className="text-lg font-semibold text-gray-900 mb-4">What's next?</h3>
                        <ul className="space-y-3 text-left">
                            <li className="flex items-start">
                                <Check className="w-5 h-5 text-green-600 mr-3 mt-0.5 flex-shrink-0" />
                                <span className="text-gray-700">Create your first post and share your thoughts</span>
                            </li>
                            <li className="flex items-start">
                                <Check className="w-5 h-5 text-green-600 mr-3 mt-0.5 flex-shrink-0" />
                                <span className="text-gray-700">Follow interesting users to build your feed</span>
                            </li>
                            <li className="flex items-start">
                                <Check className="w-5 h-5 text-green-600 mr-3 mt-0.5 flex-shrink-0" />
                                <span className="text-gray-700">Engage with posts through likes and comments</span>
                            </li>
                            <li className="flex items-start">
                                <Check className="w-5 h-5 text-green-600 mr-3 mt-0.5 flex-shrink-0" />
                                <span className="text-gray-700">Customize your profile to express yourself</span>
                            </li>
                        </ul>
                    </div>
                </div>
